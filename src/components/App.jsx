      ...
      <MuiThemeProvider>
        <div>
          ...
          <Switch>
            ...
            <Route path='/admin' render={(props)=><Admin kegList={this.state.masterKegList} currentRouterPath={props.location.pathname} onKegSelection={this.handleDeletingNewKegFromList} selectedKeg={this.state.selectedKeg}/>} />
